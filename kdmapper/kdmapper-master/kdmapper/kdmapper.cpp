...
uint64_t kdmapper::MapDriver(HANDLE iqvw64e_device_handle, std::vector<uint8_t> raw_image, ULONG64 param1, ULONG64 param2, bool free, bool destroyHeader, bool mdlMode, bool PassAllocationAddressAsFirstParam, mapCallback callback, NTSTATUS* exitCode) {
